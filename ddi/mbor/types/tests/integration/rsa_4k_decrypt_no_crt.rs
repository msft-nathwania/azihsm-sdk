...
#[test]
fn test_rsa_4k_decrypt_no_session() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
            let (_key_id_rsa4k_pub, key_id_rsa4k_priv, _) =
                store_rsa_keys_no_crt(dev, session_id, DdiKeyUsage::EncryptDecrypt, 4, None);
            ...
            let resp = helper_rsa_mod_exp(
                ...
                key_id_rsa4k_priv,
                MborByteArray::new([0x1; 512], 512).expect("failed to create byte array"),
...
#[test]
fn test_rsa_4k_decrypt_incorrect_session_id() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
...
#[test]
fn test_rsa_4k_decrypt_incorrect_key_num_table() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
...
#[test]
fn test_rsa_4k_decrypt_incorrect_key_num_entry() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
...
#[test]
fn test_rsa_4k_decrypt_incorrect_key_type() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
...
#[test]
fn test_rsa_4k_encrypt_and_decrypt() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
