...
pub enum TborStatus {
    ...
    // TBOR wire-decode failures (mirror of HsmError::Tbor*). Emitted by
    // the FW decoder for distinct structural wire faults.
    ...
    // TBOR wire-encode failures (mirror of HsmError::Tbor*).
    ...
    CannotSessionCloseInUse = 0x08700031,
    CannotCloseSomeSessionsInUse = 0x08700032,
    CannotDeleteKeyAndSessionCloseInUse = 0x08700033,
